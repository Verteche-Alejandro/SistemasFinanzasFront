                ...
                <div className="w-[20vw] p-10 ">
                    ...
                    <Form>
                        <div className="relative w-full mb-4">
                            <InputForm placeHolder={"Usuario"} icono={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                        ...
                        <InputForm type={"password"} placeHolder={"Contraseña"} icono={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
